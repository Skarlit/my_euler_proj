	...
	function renderDOM() {
	  ...
	  (0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: '/', component: _components.Index },
	      _react2.default.createElement(_reactRouter.IndexRoute, { component: _components.Home }),
	      _react2.default.createElement(_reactRouter.Route, { path: 'problem/:id', component: _components.Content }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Code = exports.Description = exports.NoMatch = exports.Content = exports.Home = exports.Index = undefined;
	...
	var Index = exports.Index = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    (0, _util.getIndex)().then(function (res) {
	      _this.setState({ index: res.data.index });
	    });
	  },
	  render: function render() {
	    ...
	    for (var i = 0; i < this.state.index.length; i++) {
	      ...
	      indices.push(_react2.default.createElement(
	        _reactRouter.Link,
	        { className: 'problem-link', to: '/problem/' + idx, key: 'problem-' + idx },
	        idx
	      ));
	    }
	...
	var Content = exports.Content = _react2.default.createClass({
	  ...
	  shouldComponentUpdate: function shouldComponentUpdate(nextProp) {
	  ...
	  fetch: function fetch() {
	    ...
	    (0, _util.fetchProblem)(this.props.params.id, function (problem) {
	      _this2.setState({ problem: problem });
	    });
	  },
	  render: function render() {
	    var codes = [];
	    if (this.state.problem) {
	      this.state.problem.getCodes().forEach(function (code) {
	        codes.push(_react2.default.createElement(Code, { language: code.language, text: code.text, filename: code.filename, url: code.url }));
	      });
	    }
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(Description, { text: this.state.problem ? this.state.problem.getDescription().text : "" }),
	      codes
	    );
	  }
	});

	var NoMatch = exports.NoMatch = _react2.default.createClass({
	  displayName: 'NoMatch',
	  render: function render() {
	    return _react2.default.createElement(
	      'h1',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'code',
	          { className: _config.languages[this.props.language] },
	          this.props.text
	        )
	      )
	    );
	...
	var Problem = function () {
	  ...
	  _createClass(Problem, [{
	    ...
	    value: function fetch(cb) {
	      var promises = [];
	      promises.push(_axios2.default.get(this.manifest.description.url));
	      this.manifest.codes.forEach(function (code) {
	        promises.push(_axios2.default.get(code.url));
	      });
